...
def parse_opt():
    ...
    parser.add_argument('--data_train', type=str, default="../data/Weibo/train_for_user.csv",
                        help='training set data dir')
    parser.add_argument('--data_test', type=str, default="../data/Weibo/test_for_user.csv",
                        help='testing set data dir')
    parser.add_argument('--data_profile', type=str, default="../data/Weibo/profile.csv",
                        help='profile data dir')
    parser.add_argument('--data_tweets', type=str, default="../data/Weibo/tweets.csv",
    ...
    parser.add_argument('--pretrain_grouping_module', type=str, default=".glove/glove.6B.300d.txt",
                        help='embedding_dir')
    parser.add_argument('--data_grouping', type=str, default="../data/Weibo/friend_tag_for_user.csv",
    ...
    parser.add_argument('--data_friends_embedding', type=str, default="../data/Weibo/attention-embedding/embedding_length",
                        help='training set data dir')
