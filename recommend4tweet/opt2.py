...
def parse_opt():
    ...
    parser.add_argument('--learning_rate_ratio', type=float, default=0.01,
                        help='the lr ratio for lstm module compared with others')
    parser.add_argument('--l2_lstm', type=float, default=1e-5,
    ...
    parser.add_argument('--nheads', type=int, default=3, help='nheads for self-attention')
    parser.add_argument('--data_friends_embedding', type=str, default="../data/Weibo/attention-embedding/embedding_length",
                        help='training set data dir')
    parser.add_argument('--walk_length', type=int, default=120,
