...
def parse_opt():
    ...
    parser.add_argument('--model', type=str, default="global_sum_embedding",
                        help='model name')
    ...
    parser.add_argument('--data_train', type=str, default="../data/Twitter/train_for_tweet.csv",
                        help='training set data dir')
    parser.add_argument('--data_test', type=str, default="../data/Twitter/test_for_tweet.csv",
                        help='testing set data dir')
    parser.add_argument('--data_friends', type=str, default="../data/Twitter/profile.csv",
    ...
    parser.add_argument('--pretrain_grouping_module', type=str, default=".glove/glove.6B.300d.txt",
                        help='embedding_dir')
    parser.add_argument('--data_grouping', type=str, default="../data/Twitter/friend_tag_for_tweet.csv",
