...
def parse_opt():
    ...
    parser.add_argument('--data_train', type=str, default="../data/train_for_user.csv",
                        help='training set data dir')
    parser.add_argument('--data_test', type=str, default="../data/test_for_user.csv",
                        help='testing set data dir')
    parser.add_argument('--data_friends', type=str, default="../data/profile.csv",
    ...
    parser.add_argument('--pretrain_grouping_module', type=str, default=".glove/glove.6B.300d.txt",
                        help='embedding_dir')
    parser.add_argument('--data_grouping', type=str, default="../data/friend_tag_for_user.csv",
